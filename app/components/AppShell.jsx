...
import { useMainTabRoute } from '../hooks/useMainTabRoute';
    ...
    <AppRuntimeProvider state={runtimeState} actions={runtimeActions}>
      ...
      >
        {mainTab === 'mine' ? (
          ...
          <div className="mobile-main-tab-panel mobile-main-tab-panel--home" style={{ display: 'contents' }}>
            <>
              <Announcement />
              <div className="navbar glass" ref={navbarRef}>
                ...
                <div
                  className={`actions ${isSearchFocused || selectedFunds.length > 0 ? 'search-focused-sibling' : ''}`}
                >
