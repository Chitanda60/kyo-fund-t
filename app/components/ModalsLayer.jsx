...
// 低频弹窗：懒加载
const CloudConfigModal = dynamic(() => import('./modals/settings/CloudConfigModal'), { ssr: false });
const DonateModal = dynamic(() => import('./modals/common/DonateModal'), { ssr: false });
const FeedbackModal = dynamic(() => import('./modals/common/FeedbackModal'), { ssr: false });
const WeChatModal = dynamic(() => import('./modals/common/WeChatModal'), { ssr: false });
const DcaModal = dynamic(() => import('./modals/trading/DcaModal'), { ssr: false });
const FundConvertModal = dynamic(() => import('./modals/trading/FundConvertModal'), { ssr: false });
const SelectFundSingleModal = dynamic(() => import('./modals/scan/SelectFundSingleModal'), { ssr: false });
const SelectHoldingGroupModal = dynamic(() => import('./modals/group/SelectHoldingGroupModal'), { ssr: false });
const ScanImportConfirmModal = dynamic(() => import('./modals/scan/ScanImportConfirmModal'), { ssr: false });
const ScanImportProgressModal = dynamic(() => import('./modals/scan/ScanImportProgressModal'), { ssr: false });
const ScanPickModal = dynamic(() => import('./modals/scan/ScanPickModal'), { ssr: false });
const ScanProgressModal = dynamic(() => import('./modals/scan/ScanProgressModal'), { ssr: false });
const AddHistoryModal = dynamic(() => import('./modals/trading/AddHistoryModal'), { ssr: false });
const AllSectorsModal = dynamic(() => import('./modals/fund-detail/AllSectorsModal'), { ssr: false });
const DividendMethodModal = dynamic(() => import('./modals/trading/DividendMethodModal'), { ssr: false });

// 高频组件：同步加载
import ConfirmModal from './modals/common/ConfirmModal';
import GroupManageModal from './modals/group/GroupManageModal';
import GroupModal from './modals/group/GroupModal';
import HoldingEditModal from './modals/trading/HoldingEditModal';
import HoldingActionModal from './modals/trading/HoldingActionModal';
import LoginModal from './modals/common/LoginModal';
import SettingsModal from './modals/settings/SettingsModal';
import SuccessModal from './modals/common/SuccessModal';
import TradeModal from './modals/trading/TradeModal';
import TransactionHistoryModal from './modals/trading/TransactionHistoryModal';
import TutorialDrawer from './modals/common/TutorialDrawer';
